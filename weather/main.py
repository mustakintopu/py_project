...
class Weather:
    def weather_report(self):
        ...
        self.api_key = '07522802429f9148fc72239e64083339'
        if not self.api_key:
            messagebox.showerror('Error', 'API Key not found. Set it as an environment variable.')
            return
    ...
    def __init__(self):
        ...
        self.img = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "icon.png")))
        self.img2 = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "icon2.png")))
        self.img3 = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "icon3.png")))
        self.img4 = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "icon4.png")))
        self.img5 = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "icon5.png")))
